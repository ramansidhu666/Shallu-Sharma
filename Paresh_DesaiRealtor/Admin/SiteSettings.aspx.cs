...
namespace Property.Admin
{
    public partial class SiteSettings : System.Web.UI.Page
    {
        ...
        public void bindddl()
        {
            ...
            if(dt.Rows.Count > 0)
            {
                //ddlSales Representativeage.DataSource = dt;
                //ddlSales Representativeage.DataValueField = "mls";
                //ddlSales Representativeage.DataTextField = "ListSales Representativeage";
               // ddlSales Representativeage.DataBind();
                //ddlSales Representativeage.Items.Insert(0, new ListItem("CITYSCAPE REAL ESTATE LTD., Sales RepresentativeAGE", "0"));
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < FileColl.Count; i++)
                {
                    ...
                    cmd.Parameters.AddWithValue("@ListSales Representativeage", "");
